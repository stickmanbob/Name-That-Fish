...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-jdnaeg");
    			add_location(h1, file$6, 6, 8, 48);
    			attr_dev(p, "class", "svelte-jdnaeg");
    			add_location(p, file$6, 8, 8, 72);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "href", "https://github.com/stickmanbob/svelteQuizGame#readme");
    			add_location(a0, file$6, 11, 16, 171);
    			attr_dev(li0, "class", "svelte-jdnaeg");
    			add_location(li0, file$6, 11, 12, 167);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", "https://ajay-rajamani.me");
    			add_location(a1, file$6, 12, 16, 280);
    			attr_dev(li1, "class", "svelte-jdnaeg");
    			add_location(li1, file$6, 12, 12, 276);
    			attr_dev(ul, "class", "svelte-jdnaeg");
    			add_location(ul, file$6, 10, 8, 150);
    			attr_dev(i, "class", "fas fa-copyright");
    			add_location(i, file$6, 16, 12, 410);
    			attr_dev(span, "class", "copyright svelte-jdnaeg");
    			add_location(span, file$6, 15, 8, 373);
    			attr_dev(div, "class", "svelte-jdnaeg");
    			add_location(div, file$6, 5, 4, 34);
    			attr_dev(footer, "class", "svelte-jdnaeg");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 8, 0, 180);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Game, Footer });
    	return [];
    }
