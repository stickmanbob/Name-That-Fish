...
var app = (function () {
    ...
    var fishURLs = {
    	"Small Mouth Bass": "https://www.fws.gov/fisheries/freshwater-fish-of-america/images/originals/east_warm/Smallmouth_bass_DuaneRavenArt.png",
    	"Large Mouth Bass": "https://www.fws.gov/fisheries/freshwater-fish-of-america/images/originals/east_warm/Largemouth_bass_DuaneRavenArt.png",
    	Clownfish: Clownfish,
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-o5cq97");
    			add_location(main, file$1, 7, 0, 131);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
